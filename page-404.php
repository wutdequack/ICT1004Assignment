...
<head>
    ...
    <title>Mei Heong Yuan Dessert - 404</title>

    <meta name="description" content="404">
    <meta name="keywords" content="getlost">
...
<div class="nk-header-title nk-header-title-full nk-header-title-parallax-content nk-header-content-center-center">
    ...
    <div class="bg-image bg-image-parallax">
        <img src="assets/images/404-error.jpg" alt="" class="jarallax-img">
    ...
    <div class="row vertical-gap">
        <div class="col-lg-7 text-center">
            <h1 class="display-extra-big">404</h1>
            <div class="nk-gap mnt-3"></div>

            <p class="nk-heading-font text-black lead">We are sorry. But the page you are looking <br> for cannot be found.</p>

            <div class="nk-gap mnt-10"></div>

            <a href="index.html" class="nk-btn nk-btn-color-dark-1">Back to Home</a>
