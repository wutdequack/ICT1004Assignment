...
<head>
    ...
    <title>Mei Heong Yuan Desserts - Chinatown</title>

    <meta name="description" content="Location-Chinatown">
...
<div class="nk-header-title nk-header-title-md nk-header-title-parallax-content nk-header-content-center-center">
    <div class="bg-image bg-image-parallax">
        <img src="assets/images/chinatown-2.png" alt="" class="jarallax-img">
...
<div class="container">
    <div class="nk-portfolio-single">
        ...
        <h1 class="nk-portfolio-title display-4">Chinatown Main Outlet</h1>
        <div class="row vertical-gap">
            <div class="col-lg-8">
                <div class="nk-portfolio-info">
                    <div class="nk-portfolio-text">
                        <p>The flagship shop of the franchise, it is a great place for tourists to get a cool bite into Singapore's culture as they seek respite from the blistering heat of Singapore.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
...
<script>
    function initializeGmaps() {
        var LatLng = {lat: 1.28333, lng: 103.84338};
...
<div class="nk-pagination nk-pagination-center">
    <div class="container">
        <a class="nk-pagination-prev" href="location-northpoint-city.html"><span class="pe-7s-angle-left"></span> Yishun Outlet</a>
            <a class="nk-pagination-next" href="location-chinatown-point.html"> <span class="pe-7s-angle-right"></span> Chinatown Point Outlet</a>
    </div>
</div>
<!-- END: Pagination -->
