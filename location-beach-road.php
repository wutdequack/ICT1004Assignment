...
<head>
    ...
    <title>Mei Heong Yuan Desserts - Beach Road</title>

    <meta name="description" content="Location-BeachRoad">
...
<div class="nk-header-title nk-header-title-md nk-header-title-parallax-content nk-header-content-center-center">
    <div class="bg-image bg-image-parallax">
        <img src="assets/images/beach-road.jpg" alt="" class="jarallax-img">
...
<div class="container">
    <div class="nk-portfolio-single">
        ...
        <h1 class="nk-portfolio-title display-4">Beach Road Outlet</h1>
        <div class="row vertical-gap">
            <div class="col-lg-8">
                <div class="nk-portfolio-info">
                    <div class="nk-portfolio-text">
                        <p>Located at a location rich in history, deep in its Hainan roots and back when it formed the iconic coastal line, it has now been transformed to the fringe of a growing metropolitan skyline. What could be better than to appreciate the traditional desserts of Mei Heong Yuan whilst glimpsing at the beautiful of the sunny island of Singapore?</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
...
<script>
    function initializeGmaps() {
        var LatLng = {lat: 1.3014598, lng: 103.8616421};
...
<div class="nk-pagination nk-pagination-center">
    <div class="container">
        <a class="nk-pagination-prev" href="location-marina-square.html"><span class="pe-7s-angle-left"></span> Marina Square Outlet</a>
        <a class="nk-pagination-next" href="location-northpoint-city.html"><span class="pe-7s-angle-right"></span>Northpoint City@Yishun </a>
    </div>
</div>
<!-- END: Pagination -->
