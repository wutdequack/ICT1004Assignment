...
<head>
    ...
    <title>Mei Heong Yuan Desserts - Clementi Mall</title>

    <meta name="description" content="Location-Clementi-Mall">
...
<div class="nk-header-title nk-header-title-md nk-header-title-parallax-content nk-header-content-center-center">
    <div class="bg-image bg-image-parallax">
        <img src="assets/images/clementimall-1.jpg" alt="" class="jarallax-img">
...
<div class="container">
    <div class="nk-portfolio-single">
        ...
        <h1 class="nk-portfolio-title display-4">Clementi Mall Outlet</h1>
        <div class="row vertical-gap">
            <div class="col-lg-8">
                <div class="nk-portfolio-info">
                    <div class="nk-portfolio-text">
                        <p>Calling out to all our West-siders, we have heard your cries for real authentic Chinese dessert and brought it to Clementi! Come, don't hesitate, don't resist. Enjoy with us today!</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
...
<script>
    function initializeGmaps() {
        var LatLng = {lat: 1.31491, lng: 103.7643};
...
<div class="nk-pagination nk-pagination-center">
    <div class="container">
        <a class="nk-pagination-prev" href="location-chinatown-point.html"><span class="pe-7s-angle-left"></span> Chinatown Point Outlet</a>
        <a class="nk-pagination-next" href="location-velocity-novena.html"><span class="pe-7s-angle-right"></span>Velocity@Novena Outlet</a>
    </div>
</div>
<!-- END: Pagination -->
