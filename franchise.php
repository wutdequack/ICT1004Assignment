...
<head>
    ...
    <title>Mei Heong Yuan Dessert - Franchise</title>

    <meta name="description" content="Franchise">
    <meta name="keywords" content="dessert, food, asian, contactUs">
    <meta name="author" content="Ho Xiu Qi">
...
<div class="container">
    ...
    <div class="row vertical-gap">
        <div class="col-lg-5">
            <!-- START: Info -->
            <h2 class="display-4">Franchise</h2>
            <div class="nk-gap mnt-3"></div>

            <p>
				Are you looking for a <i>business opportunity</i>? Well, we are!<br/><br/>
				If you like the idea of running a dessert business like ours, why not speak to us.<br/><br/>
				We are looking to expand our business <i>locally</i> and <i>overseas</i> and would be doing it through Franchising.<br/><br/>
				Do provide us with more details using our <a href="./MHY - Franchise Enquiry Form MHYD.docx" download>Franchise Enquiry Form</a> and email it to the email address below!<br/><br/>
				You can also <i>send us a message</i> through the form on this page, or reach us through the following contact information.
			</p>

            <ul class="nk-contact-info">
                <li><strong>Phone:</strong>+65 6221 1156</li>
                <li><strong>Email:</strong> franchise@farmerpeanuts.com</li>
                <li><strong>Fax:</strong> (65) 6779 3562</li>
            </ul>
            <!-- END: Info -->
        </div>
        <div class="col-lg-7">
            ...
            <form action="php/ajax-contact-form.php" class="nk-form nk-form-ajax">
                ...
                <div class="nk-gap-1"></div>
                <textarea class="form-control required" name="message" rows="8" placeholder="Your Message" aria-required="true"></textarea>
                <div class="nk-gap-1"></div>
                <div class="nk-form-response-success"></div>
                <div class="nk-form-response-error"></div>
                <button class="nk-btn nk-btn-color-dark-1">Send Message</button>
            </form>
            <!-- END: Form -->
        </div>
    </div>
